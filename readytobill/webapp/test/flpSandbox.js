		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ready To Bill",
									"targetURL": "#comchappotareadytobillreadytobill-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comchappotareadytobillreadytobill-display": {
								"semanticObject": "comchappotareadytobillreadytobill",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.chappota.readytobill.readytobill",
									"url": sap.ui.require.toUrl("com/chappota/readytobill/readytobill")
								}
							}
						}
					}
